...
export const WelcomePage = () => {
	...
	return (
		<div className='flex flex-col items-center px-6 text-center h-full justify-center'>
			{/* Логотип в кружке */}
			...
			<p className='text-xl text-theme-text-secondary mb-8 max-w-2xl animate-fade-in'>
				Платформа для поиска, создания и управления исполнителями для
				пэт-проектов. Находите единомышленников и воплощайте свои идеи в жизнь!
			</p>
